...
test_that("graph_data fails with invalid inputs", {
  ...
  expect_error(check_inputs(id = "id", product_id = "product"))
  expect_error(check_inputs(data = df1))
  expect_error(check_inputs(data = df1, id = "id"))
  expect_error(check_inputs(data = df1, product_id = "product"))
  expect_error(check_inputs(id = "id", product_id = "product"))
  expect_error(check_inputs(data = df2))
  expect_error(check_inputs(data = df2, id = "id"))
  expect_error(check_inputs(data = df2, product_id = "product"))
})
